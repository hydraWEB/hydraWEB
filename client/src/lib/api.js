...
export const WaterLevelAllStations = () => guestRequest_client.get(`api/v1/user/water_level/stations`)
export const WaterLevelGetDataByStNo = (data) => guestRequest_client.post(`api/v1/user/water_level/getByID`,data)
